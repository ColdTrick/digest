...
$language = array (
  ...
  'digest:settings:production' => 'In produktie',
  'digest:settings:interval:default' => 'Standaard interval instellingen',
  'digest:settings:custom_text:title' => 'Vrije tekst',
  'digest:settings:custom_text:description' => 'Hier kun je vrije teksten opnemen die toegevoegd worden aan de kop en/of foottekst van de update.',
