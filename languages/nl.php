...
$language = array (
  ...
  'digest:settings:production:title' => 'Digest productie instellingen',
  'digest:settings:production:description' => 'Als je gebruik maakt van de Digest plugin kunnen er, afhankelijk van de instellingen, veel e-mail verstuurd worden. Om er zeker van te zijn dat er geen e-mails worden verstuurd aan de gebruikers voordat je hiervoor klaar bent, is deze instelling steld je in staat het systeem te testen. Als je klaar bent kun je het systeem naar productie zetten.',
