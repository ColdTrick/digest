...
$interval_table .= "<td>" . elgg_format_bytes($site_stats[DIGEST_INTERVAL_DAILY]["total_memory"]) . "</td>";
$interval_table .= "<td>" . elgg_format_bytes($site_stats[DIGEST_INTERVAL_WEEKLY]["total_memory"]) . "</td>";
$interval_table .= "<td>" . elgg_format_bytes($site_stats[DIGEST_INTERVAL_FORTNIGHTLY]["total_memory"]) . "</td>";
$interval_table .= "<td>" . elgg_format_bytes($site_stats[DIGEST_INTERVAL_MONTHLY]["total_memory"]) . "</td>";
$interval_table .= "</tr>";
